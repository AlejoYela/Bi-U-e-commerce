      ...
      <Carousel indicators={false} controls={false} fade>
        <Carousel.Item className='position-relative' interval={5000}>
          ...
          <div className='position-absolute bottom-0 start-0 m-0 m-md-5 p-3 p-md-4'>
            ...
            <h2 className='fs-3 m-0 text-light d-none d-md-block'>Resalta tu belleza con estilo con nuestra</h2>
        ...
        <Carousel.Item className='position-relative' interval={5000}>
          ...
          <div className='position-absolute bottom-0 start-0 m-0 m-md-5 p-3 p-md-4'>
            ...
            <h2 className='fs-3 m-0 d-none d-md-block'>Descubre tu belleza auténtica con nuestra</h2>
            ...
            <div className='d-grid d-md-flex align-items-center gap-2'>
              <Link to='/productos'>
                <Button className='w-100' size='lg' variant='dark z-3 text-truncate' onClick={() => { selectCategory('all'); selectSubcategory('all') }}>Ver catálogo completo <SparklesIcon color='#FFFFFF' size={23} /></Button>
              </Link>
              <Link to='/productos'>
