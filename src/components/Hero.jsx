            ...
            <Carousel indicators={false} controls={false} fade>
                <Carousel.Item className='position-relative' interval={5000}>
                    ...
                    <div className='position-absolute bottom-0 start-0 m-0 m-md-5 p-3 p-md-4'>
                        ...
                        <div className='d-flex align-items-center gap-2'>
                            <Link to='/productos'>
                                <Button variant='light z-3 text-truncate'>Ver catálogo completo</Button>
                            </Link>
                            <Link to='/productos'>
                                <Button variant='outline-light z-3 text-truncate'>Ver catálogo completo</Button>
                            </Link>
                        </div>
                    </div>
                ...
                <Carousel.Item className='position-relative' interval={5000}>
                    ...
                    <div className='position-absolute bottom-0 start-0 m-0 m-md-5 p-3 p-md-4'>
                        ...
                        <div className='d-flex align-items-center gap-2'>
                            <Link to='/productos'>
                                <Button variant='dark z-3 text-truncate'>Ver catálogo completo</Button>
                            </Link>
                            <Link to='/productos'>
                                <Button variant='outline-dark z-3 text-truncate'>Ver catálogo de skincare</Button>
                            </Link>
                        </div>
                    </div>
                </Carousel.Item>
