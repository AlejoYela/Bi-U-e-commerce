...
export function SparklesIcon ({ color = '#593A23', size = 32, strokeWidth = 1 }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' fill='none' width={size} height={size} viewBox='0 0 24 24' strokeWidth={strokeWidth} stroke={color}>
...
export function ChatIcon ({ color = '#593A23', size = 32 }) {
  return (
